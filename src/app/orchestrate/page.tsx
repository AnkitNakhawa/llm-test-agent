...
export default function OrchestratePage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      <h1 className="text-3xl font-bold text-center">Bank Chatbot Agent Pipeline</h1>
      <button
      ...
      {data && (
        <div className="space-y-8">
          <section>
            <h2 className="text-2xl font-semibold mb-2">HardPromptAgent Output</h2>
            <div className="space-y-4">
              {data.rawCandidates.map((c, idx) => (
                <div key={idx} className="p-4 border rounded shadow-sm bg-white">
                  <p className="font-medium">Question:</p>
                  <p>{c.input}</p>
                  <p className="font-medium mt-2">Expected Answer:</p>
                  <p>{c.expected_output}</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2">PromptQualityValidator Output</h2>
            <div className="space-y-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2">Top 3 Hardest Test Cases</h2>
            <div className="space-y-4">
              {data.topCases.map((t, idx) => (
                ...
                >
                  ...
                  <p className="mt-1">Expected: {t.expected_output}</p>
                  ...
                  <p className="mt-1 text-sm">Justification: {t.justification}</p>
                </div>
              ))}
            </div>
          </section>
